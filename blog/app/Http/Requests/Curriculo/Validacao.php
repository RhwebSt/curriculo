...
class Validacao extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'esnum'=>'required|max:10|regex:/^[A-ZÀÁÂÃÇÉÈÊËÎÍÏÔÓÕÛÙÚÜŸÑÆŒa-zàáâãçéèêëîíïôóõûùúüÿñæœ 0-9_\-().]*$/', 
    ...
    public function messages()
    {
        return [
            ...
            'eslogradouro.required'=>'O campo não pode estar vazio.',
            'eslogradouro.max'=>'O campo não pode conter mais de 50 caracteres.',
            'eslogradouro.regex'=>'O campo nome social possui um formato inválido.',
            
            'esnum.required'=>'O campo não pode estar vazio.',
            'esnum.max'=>'O campo não pode conter mais de 10 caracteres.',
            'esnum.regex'=>'O campo nome social possui um formato inválido.',
            ...
            'esmunicipio.required'=>'O campo não pode estar vazio.',
            'esmunicipio.max'=>'O campo não pode conter mais de 10 caracteres.',
            'esmunicipio.regex'=>'O campo nome social possui um formato inválido.',
